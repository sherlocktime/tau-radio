...
class SquareVisualizer(tk.Toplevel):
    def __init__(self, parent, color="crimson"): # Ahora acepta el parámetro de color
        ...
        # Renderizado de figuras usando el color recibido
    ...
    def cambiar_color(self, nuevo_color):
        """Método dinámico para actualizar los colores si cambia la radio sin cerrar la ventana."""
...
if __name__ == "__main__":
    ...
    # Prueba local pasándole un color personalizado directamente
    btn = ttk.Button(root, text="Lanzar Visualizador", command=lambda: SquareVisualizer(root, color="orchid"))
